...
export const AppointmentCard: React.FC<Props> = ({ app, onCancel }) => {
  ...
  return (
    <div
      className={`bg-white rounded-[3rem] shadow-2xl border-t-8 overflow-hidden transition-all hover:scale-[1.01] ${status.borderColor}`}
    >
      <div className="p-8 md:p-10 space-y-8">
        ...
        {/* Seção de Ações: Apenas para agendamentos futuros e ativos */}
        ...
        {/* Informação de Protocolo para referência rápida */}
